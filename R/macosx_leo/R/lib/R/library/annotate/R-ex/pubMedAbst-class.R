...
###   journal pubDate abstUrl pmid pubMedAbst,pubMedAbst-method
###   authors,pubMedAbst-method abstText,pubMedAbst-method
###   articleTitle,pubMedAbst-method journal,pubMedAbst-method
###   pubDate,pubMedAbst-method abstUrl,pubMedAbst-method
###   pmid,pubMedAbst-method show,pubMedAbst-method
### Keywords: classes
