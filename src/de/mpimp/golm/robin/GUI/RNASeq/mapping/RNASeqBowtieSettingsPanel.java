 ...
 * @author marc
 */
public class RNASeqBowtieSettingsPanel extends RNASeqAbtractMappingToolSettingsPanel {

    /** Creates new form RNASeqBowtieSettingsPanel */
    public RNASeqBowtieSettingsPanel(RNASeqDataModel model, RNASeqWorkflowPanel mainpanel) {
        initComponents();
    ...
    private void initComponents() {
        ...
        seedMismatch = new javax.swing.JSpinner();
        seedLength = new javax.swing.JSpinner();
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder(null, org.openide.util.NbBundle.getMessage(RNASeqBowtieSettingsPanel.class, "RNASeqBowtieSettingsPanel.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lucida Grande", 0, 11), new java.awt.Color(0, 51, 102))); // NOI18N
        ...
        presetBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "no mismatches, unique alignments only", "up to 2 mismatches, unique alignments only", "custom" }));
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(RNASeqBowtieSettingsPanel.class, "RNASeqBowtieSettingsPanel.jLabel1.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        moreArgs.setText(org.openide.util.NbBundle.getMessage(RNASeqBowtieSettingsPanel.class, "RNASeqBowtieSettingsPanel.moreArgs.text")); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(RNASeqBowtieSettingsPanel.class, "RNASeqBowtieSettingsPanel.jLabel2.text")); // NOI18N
        ...
        jLabel3.setText(org.openide.util.NbBundle.getMessage(RNASeqBowtieSettingsPanel.class, "RNASeqBowtieSettingsPanel.jLabel3.text")); // NOI18N
        ...
        jLabel4.setText(org.openide.util.NbBundle.getMessage(RNASeqBowtieSettingsPanel.class, "RNASeqBowtieSettingsPanel.jLabel4.text")); // NOI18N
        ...
        jLabel5.setText(org.openide.util.NbBundle.getMessage(RNASeqBowtieSettingsPanel.class, "RNASeqBowtieSettingsPanel.jLabel5.text")); // NOI18N
        ...
        seedMismatch.setFont(seedMismatch.getFont().deriveFont(seedMismatch.getFont().getSize()-2f));
        seedMismatch.setModel(new javax.swing.SpinnerNumberModel(0, 0, 3, 1));
        seedMismatch.setEnabled(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 1;
        ...
        add(seedMismatch, gridBagConstraints);

        seedLength.setFont(seedLength.getFont().deriveFont(seedLength.getFont().getSize()-2f));
        seedLength.setModel(new javax.swing.SpinnerNumberModel(Integer.valueOf(28), Integer.valueOf(5), null, Integer.valueOf(1)));
        seedLength.setEnabled(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.ipadx = 12;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(2, 10, 0, 8);
        add(seedLength, gridBagConstraints);
        ...
        confirmSettingsButton.setText(org.openide.util.NbBundle.getMessage(RNASeqBowtieSettingsPanel.class, "RNASeqBowtieSettingsPanel.confirmSettingsButton.text")); // NOI18N
        ...
        saveAlignmentsButton.setText(org.openide.util.NbBundle.getMessage(RNASeqBowtieSettingsPanel.class, "RNASeqBowtieSettingsPanel.saveAlignmentsButton.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
...
private void confirmSettingsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmSettingsButtonActionPerformed
    ...
    public void setEnabled(boolean bln) {
        seedMismatch.setEnabled(bln);
        seedLength.setEnabled(bln);
...
//                } else {
                    ...
                    add("-m1");  
//                }
                add("-n"+seedMismatch.getValue());
                add("-l"+seedLength.getValue());
...
//            break;
        case 2:
            seedMismatch.setEnabled(true);
            seedLength.setEnabled(true);
    ...
    private javax.swing.JSpinner seedLength;
    private javax.swing.JSpinner seedMismatch;
    ...
    public void configureWithString(String mappingToolSettings) {
        if (mappingToolSettings.startsWith("-a;-m1;-n2;-l28;-e100;")) {
            ...
            for (String s : e) {
                if (s.startsWith("-n")) {
                    seedMismatch.setValue(Integer.parseInt(s.substring(2)));                    
                } else if (s.startsWith("-l")) {
                    seedLength.setValue(Integer.parseInt(s.substring(2)));
