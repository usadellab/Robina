...
/*
 * TMMinimumLengthPanel.java
 *
 * Created on 13.09.2011, 16:26:51
 */
 ...
 * @author marc
 */
public class TMMinimumLengthTrimmerPanel extends TMModulePanel {

    /** Creates new form TMMinimumLengthPanel */
    public TMMinimumLengthTrimmerPanel() {
        initComponents();
        this.setBorder(new WorkflowModuleBorder(WorkflowModuleBorder.BLUE_SHADOW));
    }
    
    public int getMinLength() {
        return ((Integer) minLenSpinner.getValue() ).intValue();
    }
    ...
    private void initComponents() {
        ...
        minLenSpinner = new javax.swing.JSpinner();
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(TMMinimumLengthTrimmerPanel.class, "TMMinimumLengthTrimmerPanel.jLabel1.text")); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(TMMinimumLengthTrimmerPanel.class, "TMMinimumLengthTrimmerPanel.jLabel2.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        minLenSpinner.setModel(new javax.swing.SpinnerNumberModel(Integer.valueOf(20), Integer.valueOf(1), null, Integer.valueOf(1)));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jPanel1.add(minLenSpinner, gridBagConstraints);

        jLabel3.setFont(jLabel3.getFont().deriveFont(jLabel3.getFont().getSize()-2f));
        jLabel3.setText(org.openide.util.NbBundle.getMessage(TMMinimumLengthTrimmerPanel.class, "TMMinimumLengthTrimmerPanel.jLabel3.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        helpLabel.setText(org.openide.util.NbBundle.getMessage(TMMinimumLengthTrimmerPanel.class, "TMMinimumLengthTrimmerPanel.helpLabel.text")); // NOI18N
...
private void helpLabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_helpLabelMouseClicked
    ...
    private javax.swing.JSpinner minLenSpinner;
    // End of variables declaration//GEN-END:variables

    @Override
    public TMTrimmerArguments getArguments() {        
        TMTrimmerArguments args = new TMTrimmerArguments("MINLEN"); 
        args.put("minLen", minLenSpinner.getValue());        
        return args;
    }

    @Override
    public void setArguments(TMTrimmerArguments args) {
        this.minLenSpinner.setValue( Integer.parseInt(args.get("minLen").toString()) );
    }
}
